            ...
            for supplier_id in supplier_ids:
                ...
                if len(products) > 0:
                  for product in products:
                    ...
                    supplier_product_name= product['product_name']#name product in supplier
                    ...
                    uom = cr.dictfetchone()['uom_name']# Unit of Measure 
                    #get amount taxed
