...
class jasper_client(JasperDataParser.JasperDataParser):
    ...
    def generate_records(self, cr, uid, ids, data, context):
        ...
        if 'form' in data:
            ...
            cr.execute(" Select * from res_partner where id = %s ", (fourniseur_id[0],))
            ...
            cr.execute(" Select * from account_invoice where partner_id = %s and type = %s and state != %s and  state != %s",(fourniseur_id[0],type_respart,facture_regler,facture_brouilons))
...
jasper_report.report_jasper('report.jasper_facture_clients_nonreglees_print', 'account.invoice', parser=jasper_client, )
