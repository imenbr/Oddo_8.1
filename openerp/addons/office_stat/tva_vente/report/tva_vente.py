...
class jasper_client(JasperDataParser.JasperDataParser):
    ...
    def generate_records(self, cr, uid, ids, data, context):
        ...
        if 'form' in data:
            ...
            cr.execute(" Select * from account_invoice where ( type = 'out_invoice' or type = 'out_refund')  and state != 'cancel' and date_invoice >= %s and date_invoice <= %s  ORDER by date_invoice ",(datedebut, datefin))
            ...
            if len(invoices_list) > 0:
                for invoice in invoices_list:
                    ...
                    if invoice['amount_tax'] > 0:
                        ...
                        somme_timbre_exoner += signe * round(invoice['timbre'],3)
                    ...
                    if invoice['amount_tax'] > 0:
                        for line in facture.tax_line: 
                            if (line.name == u" TVA encaissement 18.0 % - TVA collectee  sur les encaissements "):
                                tva18 = line.amount
                                base18 = line.base
                                print "tva18 :::::::::::::::::",tva18
                                print "base18 :::::::::::::::::",base18
                            ...
                            if (line.name == u"TVA encaissement 12.0 % - TVA collectee  sur les encaissements 1"):
                                tva12 = line.amount
                                base12 = line.base
                                print "tva12 :::::::::::::::::",tva12
                                print "base12 :::::::::::::::::",base12
                            ...
                            if (line.name == u"TVA encaissement 6.0 % - TVA collectee  sur les encaissements 6%"):
                                tva6 = line.amount
                                base6 = line.base
                                print "tva6 :::::::::::::::::",tva6
                                print "base6 :::::::::::::::::",base6
                            ...
                            #rim modif 28/08/2014    
                            #if line.name == '0%':
                            #    base0 = line.base
                    
                        if tva12_found == 1 :
                            somme_ttc12 += signe * (base12 +tva12)
               
                        if tva18_found == 1 :
                            somme_ttc18 += signe * (base18 +tva18)
                    
                        if tva6_found == 1 :
                            somme_ttc6 += signe * (base6 +tva6)
                    ...
                    data={
                           ...
                           'recap_somme_tva':round(somme_tva12+somme_tva18+somme_tva6,3),
                           'recap_somme_base':round(somme_base12+somme_base18+somme_base6,3),
                           'recap_somme_ttc':round(somme_ttc12+somme_ttc18+somme_ttc6+somme_exoner,3),
                           'user':obj_user.name,
                    } 
                    result.append(data)   
        print 'timbre!!!',somme_timbre_exoner            
        return result

jasper_report.report_jasper('report.jasper_tva_vente_print', 'account.invoice', parser=jasper_client, )
