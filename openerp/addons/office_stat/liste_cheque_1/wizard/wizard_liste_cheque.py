...
class wizard_liste_cheque_sttc(osv.osv_memory):
    _name = "wizard.liste.cheque.sttc"
    _description = " "
    ...
    _columns = { 
        ...
        'partner_ids':fields.many2many('res.partner','wizard_liste_cheque_partner_rel','wizard_cheque_id','partner_id', String='Client'),#-----
	...
	res={
            ...
            'report_name'   : 'jasper_liste_cheque_print_1',
            'datas': {
