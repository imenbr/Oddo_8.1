...
class jasper_client(JasperDataParser.JasperDataParser):
    ...
    def generate_records(self, cr, uid, ids, data, context):
        ...
        if 'form' in data:  
            ...
            cr.execute(" Select * from stock_picking where picking_type_id=2 and invoice_state !=  'invoiced' and state != 'cancel' ORDER by date")
...
jasper_report.report_jasper('report.jasper_bl_non_facturer_print', 'stock.move', parser=jasper_client, )
