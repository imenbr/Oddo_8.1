                    ...
                    if str(etatpiece) == str(false):
                       if str(banque_id) == str(false):
                          ...
                          if len(liste_reglementpiece) > 0:
                             ...
                             print 'liste_reglementpiece!!!=',liste_reglementpiece
