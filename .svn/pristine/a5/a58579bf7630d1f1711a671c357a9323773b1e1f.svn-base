...
class product_category_douane_line(osv.osv):
    ...
    _columns = {
        ...
        'frais_id': fields.many2one('frais.var.produit','Frais', ondelete='restrict'),
        'taux': fields.float('Taux',digits_compute= dp.get_precision('Account')),
...
class product_template(osv.osv):
    ...
    _columns = {
		...
		'categ_douane': fields.many2one('product.category.douane', 'Catégorie douane', ondelete='cascade'),       
    }
